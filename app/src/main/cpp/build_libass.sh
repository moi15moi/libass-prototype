...
CROSS_FILE_PATH="$SCRIPT_DIR/cross-file.tmp"
...
build_unibreak() {
    ...
    if [ ! -d libunibreak-6.1 ]; then
        echo "Downloading and extracting UniBreak..."
        wget -O libunibreak-6.1.tar.gz https://github.com/adah1972/libunibreak/releases/download/libunibreak_6_1/libunibreak-6.1.tar.gz
...
build_libass_and_dependencies() {
    ...
    local build_path="$SCRIPT_DIR/$android_abi"
